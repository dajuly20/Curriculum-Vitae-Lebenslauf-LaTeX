...
% Pakete
% LuaLaTeX: fontspec ist Pflicht für korrekte ß-Darstellung.
% 8-bit-Fonts (charter, lmodern) funktionieren mit LuaLaTeX nicht korrekt (ß→SS).
% Charter-OTF: sudo apt-get install texlive-fonts-extra → \setmainfont{XCharter}
\usepackage{fontspec}
\setmainfont{XCharter}           % Charter-Schrift (OTF); benötigt: texlive-fonts-extra
...
\cfoot{
	\VollerName\,\,\,\textbullet\,\,\,\AbsenderStrasse\,\,\,\textbullet\,\,\,\AbsenderPLZOrt\,\,\,\textbullet\,\,\,\Telefon
}
...
\newenvironment{AbschnittText}[1][0em]
{%
	\setlength{\AbstandAbschnitt}{#1}%
	\begin{longtable}{p{0.64\linewidth}p{0.3\linewidth}}%
		\setboolean{UnterabschnittBegonnen}{false}%
	}
	{%
	\end{longtable}%
...
% Betreff
\newcommand*{\Betreff}{\textbf{Bewerbungsanschreiben -- \Bewerberstelle}}
